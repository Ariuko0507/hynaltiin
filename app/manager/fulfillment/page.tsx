...
const currentUser = "Менежер Тэмүүжин";
...
const sentFulfillments: FulfillmentItem[] = [
  ...
  {
    id: "F-003",
    title: "Багийн гүйцэтгэлийн тайлан",
    status: "Хадгалсан",
    fromRole: "Ажилтан",
    fromName: "Дорж",
    sentTo: "Менежер Тэмүүжин",
...
const initialDrafts: Record<string, DraftState> = {
  "F-001": {
    ...
    rowNumber: "1",
    task: "Сарын төлөвлөгөөний биелэлтийг хянах, дүгнэх",
    responsibleUnit: "Төсөл хэрэгжүүлэлтийн баг",
    result: "Төлөвлөгөөний 95% биелэгдсэн. Гүйцэтгэл сайн.",
    progress: "дууссан",
  },
  "F-002": {
    year: "2026",
    ...
    sectionTitle: "Нэг. Төслийн явцын тайлан",
    rowNumber: "1",
    task: "Төслийн явцыг хянах, мэдээдэх",
    responsibleUnit: "Хөгжүүлэлтийн баг",
    result: "Төсөл 80% биелэгдэж байна. Хугацаанд хүрэхээр ажиллаж байна.",
  ...
  "F-003": {
    ...
    sectionTitle: "Нэг. Багийн гүйцэтгэлийн тайлан",
    rowNumber: "1",
    task: "Багийн гүйцэтгэлийг хянах",
    responsibleUnit: "Үйл ажиллагааны хэлтэс",
    result: "Багийн гүйцэтгэл 87% байна.",
    progress: "дууссан",
  },
...
export default function ManagerFulfillmentPage() {
  ...
  return (
    <ManagerShell
      currentPath="/manager/fulfillment"
      kicker="Fulfillment"
      title="Биелэлт хянах, шинэчлэх хэсэг"
      description="Ажилтнуудын биелэлтийг хянаж, сэтгэгдэл бичих боломжтой."
      stats={[
        ...
        <article className="rounded-[30px] border border-slate-200 bg-white p-6 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-semibold text-slate-950">{fulfillments.length} биелэлт</h2>
            </div>
          </div>

...
const sidebarLinks = [
  { href: "/director2/dashboard", label: "Самбар", icon: "DS" },
  { href: "/director2/tasks", label: "Даалгавар", icon: "TK" },
  { href: "/director2/fulfillment", label: "Биелэлт", icon: "FL" },
  { href: "/director2/meeting", label: "Хурал", icon: "MT" },
];
        ...
        <aside className="hidden w-72 shrink-0 border-r border-slate-200/80 bg-white/80 px-6 py-8 backdrop-blur lg:block">
          <div className="rounded-[28px] bg-slate-950 px-5 py-6 text-white shadow-[0_20px_60px_rgba(15,23,42,0.22)]">
            <div className="flex items-start justify-between">
              ...
              <Link href="/director2/notifications" className="relative rounded-full bg-white/10 p-2 hover:bg-white/20 transition">

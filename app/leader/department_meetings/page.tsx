...
export default function LeaderDepartmentMeetingsPage() {
  ...
  const userId = 3; // TODO: Get from auth context (Leader user ID)
        ...
        const mockData: DepartmentMeetingItem[] = [
          {
            id: 1,
            meeting_id: "DM-001",
            title: "Багийн долоо хоногийн уулзалт",
            status: "Төлөвлөсөн",
            organizer: "Багийн ахлагч Номин",
            organizer_id: 3,
            date: "2026-05-15 14:00",
            location: "Хэлтсийн танхим 301",
            description: "Долоо хоногийн ажлын хуваарь, гүйцэтгэл, илэрсэн асуудлуудыг хэлэлцэх.",
            department: "Хяналт шалгалтын хэлтэс",
          },
          {
            id: 2,
            ...
            description: "Сарын гүйцэтгэлийн тайланг хэлэлцэж, баталгаажуулах.",
            department: "Хяналт шалгалтын хэлтэс",
          },
          {
            id: 3,
            meeting_id: "DM-003",
            title: "Шинэ ажилтны ажилд оруулах хурал",
            status: "Цуцлагдсан",
            organizer: "Багийн ахлагч Номин",
            organizer_id: 3,
            date: "2026-05-08 16:00",
            location: "Хэлтсийн танхим 301",
            description: "Шинээр ажилд орсон ажилтантай танилцах, ажлын орчин, дүрэм танилцуулах.",
            department: "Хяналт шалгалтын хэлтэс",
          },
        ];
        setItems(mockData);
  ...
  return (
    <LeaderShell
      currentPath="/leader/department_meetings"
      kicker="Department Meetings"
      title="Хэлтэс доторх хурал, уулзалт"
      description="Зөвхөн таны хэлтэс доторх багийн хурал, уулзалтын хуваарь. Director 1, Director 2, Admin хэрэглэгчид оролцохгүй."
      stats={[
